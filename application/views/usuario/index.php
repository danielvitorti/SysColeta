...
<div class="card-body" >
<form name="buscausuario" id="buscausuario" action="<?=base_url('usuario')?>" method="get">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="col-lg-12">
    <div class="form-group">
        ...
        <a class="btn float-right" href="<?=base_url('usuario')?>">
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-12 col-lg-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <a href="<?=site_url('usuario')?>/cadastro" class="btn" >
            ...
            <br />
              <table id="data-table-cliente" class="table table-striped table-valign-middle">
                ...
                <tbody>
                  ...
                  ?>
             <tr class="mouseCursorPointer" onclick="window.location.href='<?=base_url('usuario/alterar')?>/<?=$value["Id"]?>'">           <td><?php echo  $value['nome'];?></td>
                        <td><?php echo  $value['Email'];?></td>
                        <td><?php echo  $value['login'];?></td>
                        <td>
                        <?php if($value['NivelAcesso'] == "1"):?> Administrador <?php endif;?>
                        <?php if($value['NivelAcesso'] == "2"):?> Motorista <?php endif;?>
                        <?php if($value['NivelAcesso'] == "3"):?> Cliente <?php endif;?>
                        </td>
              </tr>
                  <?php
                    endforeach;
