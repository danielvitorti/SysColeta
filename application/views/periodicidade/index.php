<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Periodicidades</h1>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Periodicidades</a></li>
...
<div class="card-body" >
<form name="buscaPeriodicidade" id="buscaPeriodicidade" action="<?=base_url('periodicidade')?>" method="get">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="col-lg-12">
    <div class="form-group">
        ...
        <a class="btn float-right" href="<?=base_url('periodicidade')?>">
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-12 col-lg-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <a href="<?=site_url('periodicidade')?>/cadastro" class="btn" >
            ...
            <br />
              <table id="data-table-cliente" class="table table-striped table-valign-middle">
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="mouseCursorPointer" onclick="window.location.href='<?=base_url('periodicidade/alterar')?>/<?=$value["Id"]?>'">    <td><?php echo  $value['Nome'];?></td>
...
<script>
  ...
  function buscar()
  {
    $("#buscaPeriodicidade").attr('action','<?=base_url('periodicidade')?>/index');
    $("#buscaPeriodicidade").submit();
  }
