...
<div class="card-body" >
<form name="buscaFormaPagamento" id="buscaFormaPagamento" action="<?=base_url('FormaPagamento')?>" method="get">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="col-lg-12">
    ...
    <button class="btn float-left" type="button" onclick="buscar();" >
        ...
        <a class="btn float-right" href="<?=base_url('FormaPagamento')?>">
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-12 col-lg-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <a href="<?=site_url('formaPagamento')?>/cadastro" class="btn" >
            ...
            <br />
              <table id="data-table-cliente" class="table table-striped table-valign-middle">
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="mouseCursorPointer" onclick="window.location.href='<?=base_url('formaPagamento/alterar')?>/<?=$value["Id"]?>'">
...
<script>
  ...
  function buscar()
  {
    $("#buscaFormaPagamento").attr('action','<?=base_url('formaPagamento')?>');
    $("#buscaFormaPagamento").submit();
  }
