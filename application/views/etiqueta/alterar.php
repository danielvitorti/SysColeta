...
<input type="hidden" name="Id" id="Id" value="<?=base64_encode($etiqueta['Id']) ?>" />
<div class="card-body">
<div class="form-group">
<label>Nome </label>
        <div class="input-group mb-4">
          <input type="text" class="form-control"  value="<?=$etiqueta['Descricao'] ?>" required autocomplete="off" name="Descricao" id="Descricao" placeholder="" required>   
        </div>
</div>
</div>
 &nbsp;&nbsp;&nbsp;&nbsp;
...
function excluirEtiqueta()
{
    ...
    dataType: "html"
        ...
        $(document).Toasts('create', {
                ...
                window.location.href="<?=site_url('etiqueta')?>";
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn" onclick="excluirEtiqueta();" >Sim</button>
