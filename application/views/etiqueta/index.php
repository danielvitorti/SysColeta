...
<div class="card-body" >
<form name="buscaEtiqueta" id="buscaEtiqueta" action="<?=base_url('etiqueta')?>" method="get">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="col-lg-12">
    <div class="form-group">
        ...
        <a class="btn float-right" href="<?=base_url('etiqueta')?>">
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-12 col-lg-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <a href="<?=site_url('etiqueta')?>/cadastro" class="btn" >
            ...
            <br />
              <table id="data-table-cliente" class="table table-striped table-valign-middle">
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="mouseCursorPointer" onclick="window.location.href='<?=base_url('etiqueta/alterar')?>/<?=$value["Id"]?>'">    <td><?php echo  $value['Descricao'];?></td>
                    </tr>
                  <?php
                    endforeach;
                    endif;
...
<script>
  ...
  function buscar()
  {
    $("#buscaEtiqueta").attr('action','<?=base_url('etiqueta')?>/index');
    $("#buscaEtiqueta").submit();
  }
